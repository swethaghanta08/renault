...
import Powernavbar from "../Powernavbar/Powernavbar"

const BoilerCirculationPump = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Boiler circulating pumps circulate water within the boiler to enhance boiler operation. They take suction from a header that is connected to several downcomers from the bottom of the boiler drum and discharge through additional tube circuits, the water which is pumped is at the boiler temperature and pressure. Boiler circulating pumps are designed for high temperature (usually between 150°C and 315°C, depending on boiler size and rating) and high pressure (corresponding to boiler temperature and water vapor pressure). </p>
        {/* Seal Type Button */}
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[953px]">
            ...
            Power – Renault engineers sealing technology Sealing systems featuring maximum operational reliability, convenient maintenance and low leakage rates with necessary environmental protective measures are standard requirements in modern power stations. The product range includes mechanical seals and supply systems for auxiliary and secondary pumps, boiler circulation pumps and feedwater pumps as well as mechanical seals and carbon floating ring seals for turbines, compressors and fans. Power – Renault engineers sealing technology
            </p>
          </div>
        </div>
...
export default BoilerCirculationPump
