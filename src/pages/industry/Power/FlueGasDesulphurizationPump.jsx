...
const FlueGasDesulphurizationPump = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Flue Gas Desulfurization (FGD) is a set of technologies employed to remove sulphur dioxide (SO2) from exhaust flue gases of fossil-fuel power plants, as well as from the emissions of other sulphur oxide emitting processes. The FGD technology is based on a chemical reaction that occurs when the warm exhaust gases from the coal-fired boiler come into contact with limestone.
        </p>      
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[953px]">
            ...
            Power – Renault engineers sealing technology Sealing systems featuring maximum operational reliability, convenient maintenance and low leakage rates with necessary environmental protective measures are standard requirements in modern power stations. The product range includes mechanical seals and supply systems for auxiliary and secondary pumps, boiler circulation pumps and feedwater pumps as well as mechanical seals and carbon floating ring seals for turbines, compressors and fans.
                   </p>
          </div>
        </div>
...
export default FlueGasDesulphurizationPump
