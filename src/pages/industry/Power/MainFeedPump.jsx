  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        The function of a main feed pump is to discharge the condensate boiler feed water from hot well to the boiler drum, with the rotation of shaft and impeller the hot feed water is thrown outward radially across the walls of the pump; along the path of the flow. This increases the speed of the fluid, and so does the pressure.</p>        <div className="flex items-center bg-[#E4492E] p-2 sm:p-3 md:px-8 md:py-3 mb-4 sm:mb-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[953px]">
            ...
            Power – Renault engineers sealing technology Sealing systems featuring maximum operational reliability, convenient maintenance and low leakage rates with necessary environmental protective measures are standard requirements in modern power stations. The product range includes mechanical seals and supply systems for auxiliary and secondary pumps, boiler circulation pumps and feedwater pumps as well as mechanical seals and carbon floating ring seals for turbines, compressors and fans.                        </p>
          </div>
        </div>
