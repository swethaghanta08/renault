  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        A boiler feedwater pump is a specialised pump primarily employed to pump feedwater into a steam boiler. These pumps are normally high-pressure units that take suction from a condensate return system, and can be of centrifugal pump type. Boiler feed pumps are also referred to as feed pumps. </p>
        {/* Seal Type Button */}
