  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        A feed pump is a specialised equipment that supplies water to a boiler to produce steam. For industrial purposes, a feed pump supplies a liquid for further processing. These pumps are high-pressure pumps and are generally of two types: positive displacement type feed pumps, centrifugal feed pumps.</p>        {/* Seal Type Button */}
