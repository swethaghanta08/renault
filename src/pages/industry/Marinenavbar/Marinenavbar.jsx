...
const menuItems = [
  { name: "Cooling Water Pump", path: "/industry/Marine/CoolingWaterPump" },
  {
    name: "Dredging Pump",
    path: "/industry/Marine/DredgingPump",
  },
  {
    name: "Lubricating Oil Pump",
    path: "/industry/Marine/LubricatingOilPump",
  },
  {
    name: "Gear Box",
    path: "/industry/Marine/GearBox",
  },
]
