      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        <div className="flex items-center bg-[#E4492E] p-2 sm:p-3 md:px-8 md:py-3 mb-4 sm:mb-6">
          <h3 className="text-white font-monda text-lg sm:text-xl md:text-2xl font-bold leading-[28px] md:leading-[32px]">
            Seal Type:B750VK According to API 682 Plan 52
          </h3>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[953px]">
            ...
            The processing of crude oil in refineries is a complex and multi-stage process in which crude oil is transformed 
            into refined, high-quality end products or feed materials for petrochemical industry. Sealing technology for such
             diverse applications have to meet challenges in various respects; risk of insufficient lubrication and dry running,
              media with a diversity of physical properties, high and low temperature ranges and the handling of hazardous substances
               and all other conditions which need to be controlled with absolute reliability. With a comprehensive range of API-compliant
                quality seals and supply systems Sealmatic is playing a key role towards ensuring the reliability and safety of refinery
                 processes. </p>         </div>
        </div>
...
export default LowTemperaturePump
