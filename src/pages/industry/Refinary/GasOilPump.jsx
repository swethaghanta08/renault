  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        A Discharge Pump is employed to pump and move dirty fluids to a drain point that is above ground level. Discharge pumps are also known as drain pumps. High Discharge pumps are self-priming & acting on regenerative principle. These pumps are designed for continuous operation handling and free from any suspended particles.
        </p>
