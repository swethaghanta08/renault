  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Vertical in-line pump is a type of centrifugal pump that has a vertically oriented shaft, with the suction and discharge connections in the casing in line with each other, rather than requiring a change of direction like end suction pumps, which are basically employed for refinery industries to transfer highly abrasive and corrosive fluids.</p>        {/* Seal Type Button */}
        <div className="flex items-center bg-[#E4492E] p-2 sm:p-3 md:px-8 md:py-3 mb-4 sm:mb-6">
          <h3 className="text-white font-monda text-lg sm:text-xl md:text-2xl font-bold leading-[28px] md:leading-[32px]">
            Seal Type:UFLWT800FD with API 610, Plan 53
          </h3>
        </div>
...
export default VerticalInLinePump
