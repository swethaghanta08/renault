  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        The liquefied gas pump is characteristically a centrifugal pump which are employed for handling liquefied hydrocarbons, such as propane, butane, propylene, ethylene and many more hydrocarbons in refineries and in the distillation of crude oil. The GLP pump is also employed for handling liquefied gases consisting mainly of methane.        </p>
...
export default GLPDeliveryPump
