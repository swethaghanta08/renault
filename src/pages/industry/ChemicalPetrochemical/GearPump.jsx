    ...
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        <p className="text-[#827E7D] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[24px] sm:leading-[28px] tracking-[0.4px] mb-4 sm:mb-6">
          These are widely employed in chemical installations to pump high viscosity fluids, it processes the meshing of gears to pump fluid by displacement. Gear pumps are positive displacement or fixed displacement, they pump a constant amount of fluid for each revolution.        </p>
