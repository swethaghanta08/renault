    ...
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        <p className="text-[#827E7D] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[24px] sm:leading-[28px] tracking-[0.4px] mb-4 sm:mb-6">
          Eccentric Screw Pump can handle liquids with different viscosity levels and chemical properties. These pumps have a precision mechanized single external helix metallic rotor and double internal helix elastomer stator.</p>
        {/* Seal Type Button */}
...
export default EccentricScrewPump
