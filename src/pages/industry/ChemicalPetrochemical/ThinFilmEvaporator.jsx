    ...
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        <p className="text-[#827E7D] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[24px] sm:leading-[28px] tracking-[0.4px] mb-4 sm:mb-6">
          Thin-film or thin-layer evaporators have been developed to purify temperature sensitive products by evaporation in the chemical process industries. The solution is a thin film of the liquid product on the inner side of a vertical evaporation pipe which is generated by a rotating wiper system.</p>        {/* Seal Type Button */}
...
export default ThinFilmEvaporator
