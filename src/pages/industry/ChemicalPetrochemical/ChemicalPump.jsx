    ...
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        <p className="text-[#827E7D] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[24px] sm:leading-[28px] tracking-[0.4px] mb-4 sm:mb-6">
          Chemical pumps are employed to transfer chemicals and are designed to be resistant to corrosive and abrasive industrial liquids such as fuel, paint, bleach, solvents, etc. Chemical pumps can be either centrifugal pump or a positive displacement pump depending on the specific application.        </p>
