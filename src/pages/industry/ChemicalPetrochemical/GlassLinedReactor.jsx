    ...
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        <p className="text-[#827E7D] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[24px] sm:leading-[28px] tracking-[0.4px] mb-4 sm:mb-6">
          The glass lined surfaces of the Glass Lined Vessel are hard wearing and polished during the manufacturing process, making them easily cleanable. This, in turn, makes the surfaces inherently beneficial at avoiding cross contamination in batch processing applications.</p>
        {/* Seal Type Button */}
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[953px]">
            <p className="text-[#827E7D] font-[Manrope] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[22px] sm:leading-[26px] md:leading-[28px] tracking-[0.4px]">


              The chemical/petrochemical industry requires materials capable of handling various explosive, toxic, and potentially reactive substances. With growing environmental concerns, sealing systems must prioritize reliability and operational safety .
...
export default GlassLinedReactor
