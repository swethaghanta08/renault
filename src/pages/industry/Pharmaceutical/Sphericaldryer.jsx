    ...
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        <p className="text-[#827E7D] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[24px] sm:leading-[28px] tracking-[0.4px] mb-4 sm:mb-6">
          The Spherical Dryer is a highly engineered and precision fabricated vacuum dryer designed to utilize heat input, effective mixing and vacuum for product drying. It can be employed for dedicated or multi-purpose applications and it provides the best in product quality, total discharge, cGMP production, cleanability and limited operator exposure.
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[753px]">
            <p className="text-[#827E7D] text-sm sm:text-base md:text-lg lg:text-[20px] font-normal leading-[22px] sm:leading-[26px] md:leading-[28px] tracking-[0.4px]">
              ...
              In addition to meeting technical requirements a seal has to display many other characteristics in connection
              with cleanliness, health and general legislation. These include for example materials which are compatible with food,
              smooth and abrasion-proof surfaces which are easy to clean, complete units which can be sterilized and cleaned without
              having to be dismantled (SIP/CIP). Sealmatic mechanical seals have been used for such demanding applications with great
              success in sterile processes. Our range of mechanical seals includes a broad spectrum of high-quality, specifically
              optimized sealing solutions ranging from standard solutions to specialized system solutions for nearly any application
