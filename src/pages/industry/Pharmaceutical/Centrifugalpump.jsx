  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Centrifugal Pumps are most widely employed pumps in the Oil & Gas Field and many such process industries, to transfer highly abrasive fluids like crude oil.
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[753px]">
            ...
            compatible with food, smooth and abrasion-proof surfaces which are easy to clean, complete units which can be
             sterilized and cleaned without having to be dismantled (SIP/CIP). Sealmatic mechanical seals have been used for
              such demanding applications with great success in sterile processes. Our range of mechanical seals includes a 
              broad spectrum of high-quality, specifically optimized sealing solutions ranging from standard solutions to
               specialized system solutions for nearly any application in the pharmaceutical industry.
            </p>
          </div>
        </div>
...
export default Centrifugalpumo
