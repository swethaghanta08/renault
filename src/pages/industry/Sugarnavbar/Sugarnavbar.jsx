...
const menuItems = [
  { name: "Flume Water Pump", path: "/industry/Sugar/FlumeWaterPump" },
  {
    name: "Juice Circulating Pump",
    path: "/industry/Sugar/JuiceCirculatingPump",
  },
  {
    name: "Thick Juice Pump",
    path: "/industry/Sugar/ThickJuicePump",
  },
  {
    name: "Mash Pump",
    path: "/industry/Sugar/MashPump",
  },
  { name: "Worm Type Agitator", path: "/industry/Sugar/WormTypeAgitator" },
]
