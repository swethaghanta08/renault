...
const menuItems = [
  { name: "Discharge Pump", path: "/industry/Refinary/DischargePump" },
  {
    name: "Gas Oil Pump",
    path: "/industry/Refinary/GasOilPump",
  },
  {
    name: "GLP Delivery Pump",
    path: "/industry/Refinary/GLPDeliveryPump",
  },
  {
    name: "Quench Oil Pump",
    path: "/industry/Refinary/QuenchOilPump",
  },
  { name: "Residual Oil Pump", path: "/industry/Refinary/ResidualOilPump" },
  {
    name: "Vertical In-Line Pump",
    path: "/industry/Refinary/VerticalInLinePump",
  },
  {
    name: "Low Temperature Pump",
    path: "/industry/Refinary/LowTemperaturePump",
  },
]

const Refinarynavbar = () => {
