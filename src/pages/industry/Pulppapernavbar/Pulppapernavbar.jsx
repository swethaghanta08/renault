...
const menuItems = [
  { name: "Pressure Grinder", path: "/industry/Pulppapaper/PressureGrinder" },
  {
    name: "Pulp Pump",
    path: "/industry/Pulppapaper/PulpPump",
  },
  {
    name: "Digesting & Bleaching Pump",
    path: "/industry/Pulppapaper/DigestingBleachingPump",
  },
  {
    name: "Deinking Pump",
    path: "/industry/Pulppapaper/DeinkingPump",
  },
  {
    name: "Refiner",
    path: "/industry/Pulppapaper/Refiner",
  },
  {
    name: "Stock Pump",
    path: "/industry/Pulppapaper/StockPump",
  },
]

const Pulppapernavbar = () => {
...
export default Pulppapernavbar