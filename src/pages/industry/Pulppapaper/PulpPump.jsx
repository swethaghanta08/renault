  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Pulp pumps are employed for transporting mixtures of liquid and solid components (e.g., fibrous materials in the pulp and paper industry). Large inspection holes facilitate a quick and easy removal of any clogging. Special impeller types are fitted which matches the type of pulp and the pump application.        </p>
        {/* Seal Type Button */}
