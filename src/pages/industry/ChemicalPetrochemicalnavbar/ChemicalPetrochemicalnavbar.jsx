...
const menuItems = [
  { name: "Agitator Bead Mill", path: "/industry/ChemicalPetrochemical/AgitatorBeadMill" },
  {
    name: "Chemical Pump",
    path: "/industry/ChemicalPetrochemical/ChemicalPump",
  },
  {
    name: "Eccentric Screw Pump",
    path: "/industry/ChemicalPetrochemical/EccentricScrewPump",
  },
  {
    name: "Gear Pump",
    path: "/industry/ChemicalPetrochemical/GearPump",
  },
  { name: "Glass Lined Reactor", path: "/industry/ChemicalPetrochemical/GlassLinedReactor" },
  {
    name: "Thin Film Evaporator",
    path: "/industry/ChemicalPetrochemical/ThinFilmEvaporator",
  },
  {
    name: "Chemical Reactor",
    path: "/industry/ChemicalPetrochemical/ChemicalReactor",
  },
  {
    name: "Rotary Piston Pump",
    path: "/industry/ChemicalPetrochemical/RotaryPistonPump",
  },
]

const ChemicalPetrochemicalnavbar = () => {
...
export default ChemicalPetrochemicalnavbar