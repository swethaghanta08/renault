...
import Sugarnavbar from "../Sugarnavbar/Sugarnavbar"

const ThickJuicePump= () => {
  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Juice pumps are basically employed for pumping juice from the collection tank into containers where the juice is further processed or where it is collected between different processing steps, juice pumps are available as a stand-alone pump or integrated with juice collection tanks.        </p>
