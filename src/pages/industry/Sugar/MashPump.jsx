  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Mash pump is designed to transport fruit mash from the mill to the press. It will delicately transfer the mash as it is pumped without great pressure and therefore keeps it intact.        </p>
