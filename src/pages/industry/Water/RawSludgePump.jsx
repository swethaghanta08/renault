  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        A pump which is employed to process and transfer waste fluids with high solid content is known as raw sludge pump. This is similar to slurry pumps, mud pumps, and other types of waste water pumps. Sludge pump requires a high-powered mechanism to move fluids that are extremely heavy and sometimes viscous and full of volatile or corrosive content. They are commonly employed in municipal sewage treatment applications, as well as in mining, construction, agriculture, or industrial applications in which heavy waste fluids are processed.</p>
        {/* Seal Type Button */}
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="w-full lg:max-w-[953px]">
            ...
            Municipal and Industrial sewage is conveyed by waste water pumps into collection tanks at the sewage works. Sewage works pumps are usually operated with single seals in either a dead-end arrangement (conical) seal chamber or with product circulation or external flushing (cylindrical seal chamber). While standard seals are in many cases adequate for applications involving the supply of fresh water or conveyance of waste water, special engineering solutions are a necessity where heavy-duty applications in the spheres of drinking water supply or seawater desalination plants are concerned. On the other hand, thermal energy provision requires individual account to be taken of parameters such as pressure, temperature, sliding velocity, friction, water quality and additives. Their high quality ensures that Sealmatic seals significantly boost the availability of pumps in all types of water-related applications.            </p>
          </div>
        </div>
