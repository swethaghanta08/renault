...
const DesalinizationOfSeaWater = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Desalination can be defined as any process which removes excess salts and minerals from water, or the chemical process of changing seawater into potable water. These processes may be employed for municipal, industrial or any commercial practices.        </p>
...
export default DesalinizationOfSeaWater
