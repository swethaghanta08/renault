  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Submersible agitator or mixer is an equipment that is basically employed to mix sludge tanks and other liquid volumes, they are often employed in sewage treatment plants to keep solids in suspension, in the various process tanks and/or sludge holding tanks.</p>        <div className="flex items-center bg-[#E4492E] p-2 sm:p-3 md:px-8 md:py-3 mb-4 sm:mb-6">
