...
const menuItems = [
  { name: "Boiler Circulation Pump", path: "/industry/Power/BoilerCirculationPump" },
  {
    name: "Boiler Feed Pump",
    path: "/industry/Power/BoilerFeedPump",
  },
  {
    name: "Feed Pump",
    path: "/industry/Power/FeedPump",
  },
  {
    name: "Main Feed Pump",
    path: "/industry/Power/MainFeedPump",
  },
  { name: "Flue Gas Desulphurization Pump", path: "/industry/Power/FlueGasDesulphurizationPump" },
  {
    name: "Residue Evacuation Pump",
    path: "/industry/Power/ResidueEvacuationPump",
  },
  {
    name: "Condensate Pump",
    path: "/industry/Power/CondensatePump",
  },
]
