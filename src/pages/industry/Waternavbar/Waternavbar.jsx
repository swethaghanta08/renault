...
const menuItems = [
  { name: "Hot Water", path: "/industry/Water/HotWater" },
  {
    name: "Desalinization Of Sea Water",
    path: "/industry/Water/DesalinizationOfSeaWater",
  },
  {
    name: "Non-Clogging Pump",
    path: "/industry/Water/NonCloggingPump",
  },
  {
    name: "Raw Sludge Pump",
    path: "/industry/Water/RawSludgePump",
  },
  { name: "Sewage Block Pump", path: "/industry/Water/SewageBlockPump" },
  {
    name: "Submersible Agitator",
    path: "/industry/Water/SubmersibleAgitator",
  },
  {
    name: "Submersible Pump",
    path: "/industry/Water/SubmersiblePump",
  },
]
