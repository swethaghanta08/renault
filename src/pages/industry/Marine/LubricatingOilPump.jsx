  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-8 font-manrope">
        ...
        Lubricating oil pumps are employed to supply oil to lubrication points, e.g., for plain bearings. In case of circulation, the lubricating oil pump takes in an amount of oil from a reservoir, forces it through the lubrication points and then feeds it back to the reservoir.        </p>
...
export default LubricatingOilPump
