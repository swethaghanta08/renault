...
const VTXSingleSeals = () => {
  const [activeTab, setActiveTab] = useState(null)
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/Standard/Standardmainpage/vtx/image1.jpg")
  ...
  useEffect(() => {
    const imagesToPreload = [
      ...
      "/assets/Ourproducts/Standard/Standardmainpage/vtx/image1.jpg",
      "/assets/Ourproducts/Standard/Standardmainpage/vtx/image2.jpg"
    ]
  ...
  const partsList = [
    ...
    { no: "1.2", description: "	Bellows" },
    { no: "1.3", description: "Drive collar" },
    { no: "1.4", description: "L-ring (spring collar)" },
    { no: "2", description: "Spring" },
    { no: "3", description: "Seat" },
    { no: "4", description: "O-ring or L-ring" },
    { no: "5", description: "Spacer ring" },
    { no: "6", description: "Shaft sleeve" },
    { no: "7", description: "O-Ring" },
    { no: "8", description: "Cover" },
    { no: "9", description: "Gasket" },
    { no: "10", description: "Drive collar" },
    { no: "11", description: "Set screw" },
    { no: "12", description: "Snap ring" },
  ...
  return (
    <>
      <Helmet>
        <title>VTX Single Seals | Standard Cartridge Seals</title>
        <meta name="description" content="VTX Single Seals: Single seal configuration, unbalanced design, cartridge construction, and more. Ideal for high temperature and industrial applications." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/vtx/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/vtx/image2.jpg" />
      </Helmet>
      <section
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="VTX Single Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`VTX Single Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
