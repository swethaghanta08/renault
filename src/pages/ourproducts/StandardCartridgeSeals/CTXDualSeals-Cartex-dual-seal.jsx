...
const CTXDualSeals = () => {
  ...
  const productFeatures = [
    "Dualseal configuration",
    "Balanced design",
    "Independent of direction of rotation",
    "Cartridge construction",
    "Double pressure balanced",
    "Designed for integrated pumping device for increased efficiency and circulation",
    "Available for standard (CTX-ASPN) and big bore (CTX-ABPN) seal chambers",
    "Special Design available for teh eccentric screw pumps",
    "CTX Dual Seals"
  ]
  ...
  return (
    <>
      <Helmet>
        <title>CTX Dual Seals / Cartex Dual Seal | Standard Cartridge Seals</title>
        <meta name="description" content="CTX Dual Seals / Cartex Dual Seal: Dualseal configuration, balanced design, cartridge construction, and more. Ideal for ANSI process pumps and various industrial applications." />
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="CTX Dual Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`CTX Dual Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
