...
const CTXSingleSeals = () => {
  ...
  const productFeatures = [
    ...
    "CTX Single Seals_Cartex_Single_Seals"
  ]
  ...
  return (
    <>
      <Helmet>
        <title>CTX Single Seals / Cartex Single Seals | Standard Cartridge Seals</title>
        <meta name="description" content="CTX Single Seals / Cartex Single Seals: Single seal configuration, balanced design, cartridge construction, and more. Ideal for ANSI process pumps and various industrial applications." />
      ...
      <section className="xl:max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 xl:px-24 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-16 lg:gap-28">
          ...
          <div className="w-full lg:w-[687px] lg:pr-8">
            ...
            CTX Single Seals/Cartex Single Seals            </h1>
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="CTX Single Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`CTX Single Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
