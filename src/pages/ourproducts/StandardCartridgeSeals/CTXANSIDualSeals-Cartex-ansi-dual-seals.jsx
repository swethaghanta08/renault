...
const CTXANSIDualSeals = () => {
  ...
  const productFeatures = [
    ...
    "Available for standard (CTX-ASPN) and big bore (CTX-ABPN) seal chambers",
    "Dual  seals with flush (-ASPN, -ABPN) and with quench combined with lip seal (-ASQN, – ABQN) or throttle ring (-ASTN, -ABTN)",
    "Double pressure balanced",
    "Designed with integrated pumping device for increased efficiency in circulation.",
    "CTX ANSI Dual Seals Renault engineers",
  ]
  ...
  const partsList = [
    ...
    { no: "8", description: "Drive collar" },
    { no: "9", description: "Set screw" },
    { no: "10", description: "Snap ring" },
    { no: "11", description: "Cover" },
    { no: "12", description: "Assembly fixture (remove after installation)" },
    { no: "13", description: "HSH Cap Screw" },
    { no: "14", description: "Gasket" },
    { no: "15", description: "Lip seal (-QN), throttle ring (-TN)" },
  ]
  ...
  return (
    <>
      <Helmet>
        <title>CTX ANSI Dual Seals / Cartex ANSI Dual Seals | Standard Cartridge Seals | Renault</title>
        <meta name="description" content="CTX ANSI Dual Seals / Cartex ANSI Dual Seals: Dual seal, balanced, cartridge construction, for ANSI process pumps and more. Technical features, applications, materials, and performance." />
          ...
          <div className="w-full lg:w-auto lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="CTX ANSI Dual Seal main image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`CTX ANSI Dual Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
            ...
            <div className="flex flex-col gap-3 w-full  mx-auto lg:mx-0">
              ...
              <div className="w-full">
                <div
                  className={`flex justify-between items-center p-3 sm:p-4 px-4 sm:px-6 w-full cursor-pointer transition-all duration-300 ${
...
export default CTXANSIDualSeals
