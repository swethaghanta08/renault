...
const MTXSingleSeals = () => {
  const [activeTab, setActiveTab] = useState(null)
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/Standard/Standardmainpage/MTXSingleSeals/image3.jpg")
  ...
  useEffect(() => {
    const imagesToPreload = [
      ...
      "/assets/Ourproducts/Standard/Standardmainpage/MTXSingleSeals/image1.jpg",
      "/assets/Ourproducts/Standard/Standardmainpage/MTXSingleSeals/image2.jpg",
      "/assets/Ourproducts/Standard/Standardmainpage/MTXSingleSeals/image3.jpg"
    ]
  ...
  const productFeatures = [
    ...
    "Connections for flush and quench available",
    "Multipoint injection ring design for (-QNM, -TNM) MTX SINGLE SEALS",
  ]
...
"Seal face: Carbon graphite antimony impregnated (A), Silicon carbide (Q1)",
...
"Lip seal: NBR (P), PTFE carbon reinforced (T3)"
  ...
  const partsList = [
    { no: "1", description: "Bellows unit" },
    { no: "2,5,7", description: "O-Ring" },
    { no: "3,11", description: "Set Screw" },
    { no: "4", description: "Seat" },
    { no: "6", description: "Shaft sleeve" },
    { no: "8", description: "Cover" },
    { no: "9", description: "Lip seal (-QN) or throttle ring (-TN)" },
    { no: "10", description: "Drive collar" },
    { no: "12", description: "Retaining ring" },
    { no: "13", description: "Assembly fixture" },
    { no: "14", description: "HSH Cap Screw" },
    { no: "15", description: "Gasket" },
  ...
  return (
    <>
      <Helmet>
        <title>MTX Single Seals / Mtex Single Seals | Standard Cartridge Seals</title>
        <meta name="description" content="MTX Single Seals / Mtex Single Seals: Single seal configuration, balanced design, metal bellows, cartridge construction, and more. Ideal for high temperature and industrial applications." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/MTXSingleSeals/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/MTXSingleSeals/image2.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/MTXSingleSeals/image3.jpg" />
      </Helmet>
      <section
      ...
      >
        ...
        <div className="relative z-10 ml-[20px] sm:ml-[40px] mt-[80px] aboutcontentbox2 aboutcontentbox md:mt-[40px] md:w-[442px] md:ml-[100px] lg:ml-[240px] w-[240px] h-[100px] md:h-[121px] xl:ml-[570px] lg:h-[155px] bg-white flex flex-col items-start p-6 sm:p-10 md:gap-0 gap-0 lg:gap-4 lg:w-[605px] shadow-lg">
          ...
          {/* Heading */}
          <h2 className="text-black ml-[-10px]  md:mt-[-40px] lg:mt-[-20px] sm:ml-[-20px] font-[Monda] text-[18px] sm:text-[20px] lg:text-[36px] md:text-[28px] font-bold leading-[24px] sm:leading-[28px] md:leading-[50px] w-[216px] md:w-[402px] lg:w-[502px] ">
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="MTX Single Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`MTX Single Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
