...
const VTXDualSeals = () => {
  ...
  return (
    <>
      <Helmet>
        <title>VTX Dual Seals | Standard Cartridge Seals</title>
        <meta name="description" content="VTX Dual Seals: Dual seal configuration, balanced design, cartridge construction, and more. Suitable for eccentric screw pumps and various industrial applications." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/vtxdual/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/vtxdual/image2.jpg" />
      </Helmet>
      <section
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="VTX Dual Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`VTX Dual Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
