...
const MTXDualSeals = () => {
  ...
  const productFeatures = [
    ...
    "Stationary O-ring design",
    "Seals with API Plan 52 and API Plan 53/54 with MTX DUAL SEALS"
  ]
  ...
  const partsList = [
    ...
    { no: "19", description: "	Hex socket head screw" },
