...
const B750VNDualSeals = () => {
  const [activeTab, setActiveTab] = useState(null)
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/Standard/Standardmainpage/B550vn/image1.jpg")
  ...
  useEffect(() => {
    const imagesToPreload = [
      ...
      "/assets/Ourproducts/Standard/Standardmainpage/B550vn/image1.jpg",
      "/assets/Ourproducts/Standard/Standardmainpage/B550vn/image2.jpg"
    ]
  ...
  const productFeatures = [
   ...
   "Bi-directional design available",
  ...
  const partsList = [
    { no: "1.1.1, 2.1.1", description: "	Seal face" },
    { no: "1.1.2, 2.1.2", description: "	Driver" },
    { no: "1.1.3, 2.1.3", description: "	Thrust ring" },
    { no: "1.1.4, 2.1.4, 1.3, 2.3", description: "O-Ring" },
    { no: "1.1.5, 2.1.5", description: "Spring Sleeve" },
    { no: "1.1.6, 2.1.6", description: "Spring" },
    { no: "1.1.7", description: "Set screw" },
    { no: "1.2, 2.2", description: "Seat" },
    { no: "3", description: "Shaft sleeve" },
    { no: "4", description: "O-Ring" },
    { no: "5", description: "Key" },
    { no: "6", description: "Adapter" },
    { no: "7", description: "O-Ring" },
    { no: "8", description: "Washer" },
    { no: "9", description: "	O-Ring" },
    { no: "10", description: "Pin" },
    { no: "11", description: "Housing" },
    { no: "12", description: "HSH cap screw" },
    { no: "13", description: "Assembly fixture" },
    { no: "14", description: "Hexagon bolt" },
    { no: "15", description: "Set ring" },
  ...
  return (
    <>
      <Helmet>
        <title>B550VN Dual Seals | Standard Cartridge Seals | Renault</title>
        <meta name="description" content="B550VN Dual Seals: Dual seal, balanced, cartridge construction, API 682/ISO 21049, for ANSI process pumps and more. Technical features, applications, materials, and performance." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/B550vn/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/Standard/Standardmainpage/B550vn/image2.jpg" />
      </Helmet>
      <section
      ...
      <section className="xl:max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 xl:px-24 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-16 lg:gap-28">
          ...
          <div className="w-full lg:w-auto lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="B550VN Dual Seal main image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`B550VN Dual Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
            ...
            {/* Accordion Sections */}
            <div className="flex flex-col gap-3 w-full sm:max-w-[404px] mx-auto lg:mx-0">
              {/* Technical Features */}
...
export default B750VNDualSeals
