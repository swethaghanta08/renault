...
const UG943Single= () => {
  ...
  const materialOptions = ["Seal face: Carbon graphite antimony impregnated (A), Carbon graphite resin impregnated (B), Silicon carbide (Q1)",
    "Seat: Silicon carbide (Q1 , Q2), Aluminium oxide (V)",
    "Elastomer: NBR (P), EPDM (E), FKM (V), HNBR (X4) Metal parts: CrNiMo steel (G)",
  ]
  const performanceCapabilities = [
    "Sizes: d1 = Up to 100 mm (Up to 4.000’’)",
    "Pressure: p1 = 12 bar (174 PSI), vacuum up to 0.5 bar (7.25 PSI), up to 1 bar (14.5 PSI) with seat locking",
  ...
  const partsList = [
    ...
    { no: "1.3", description: "Driver collar" },
    { no: "1.4", description: "“L” ring (spring collar)" },
    { no: "1.5", description: "Washer" },
    { no: "1.6", description: "Corner Ring" },
      ...
      >
        ...
        <div className="relative z-10 ml-[20px] sm:ml-[40px] mt-[80px] aboutcontentbox2 aboutcontentbox md:mt-[40px] w-[240px] h-[100px] md:w-[442px] md:h-[121px] md:ml-[100px] lg:ml-[240px] lg:h-[155px] lg:w-[605px] xl:ml-[570px] bg-white flex flex-col items-start p-6 sm:p-10 gap-0 shadow-lg">
          ...
          <div className="flex items-center mt-[-20px] ml-[-10px] sm:ml-[-20px] gap-2 md:mt-[-20px] lg:mt-[-10px]">
            ...
            UG943/MG9 Single Unbalanced Seals
            </h4>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[480px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 xl:px-32 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-16 lg:gap-28">
          ...
          <div className="w-full   lg:pr-8">
            <h1 className="text-[#CF422A] font-[Monda] w-[450px] text-2xl sm:text-3xl md:text-4xl lg:text-[48px] font-bold leading-tight md:leading-[60px] self-stretch mb-6 md:mb-8">
            UG943/MG9 Single Unbalanced Seals
            </h1>
