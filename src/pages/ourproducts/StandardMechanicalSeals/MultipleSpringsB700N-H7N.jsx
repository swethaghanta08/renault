...
const MultipleSprings = () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/B700multiplesprings/image1.jpg")
  ...
  useEffect(() => {
    const imagesToPreload = [
      ...
      "/assets/Ourproducts/StandardMechanicalSeals/B700multiplesprings/image1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/B700multiplesprings/image2.jpg"
    ]
  ...
  const productFeatures = [
    ...
    "Pumping device available for increased efficiency in circulation (B700F, B750F) ",
    "High temperature application with cooled stationary seats available.",
    "B700N Single Balanced Seals: High-performance seals designed for optimal sealing in demanding industrial applications.",
  ]
  ...
  return (
    <>
      <Helmet>
        <title>B700N/H7N Single Balanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="B700N/H7N Single Balanced Seals: high-performance, multiple/wave springs, for stepped shafts and high temperature. See features, materials, and technical details." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/B700multiplesprings/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/B700multiplesprings/image2.jpg" />
      </Helmet>
      <section
        ...
        aria-label="B700N/H7N Single Balanced Seals hero section"
      >
        ...
        <div className="relative z-10 ml-[20px] sm:ml-[40px] mt-[80px] aboutcontentbox2 aboutcontentbox md:mt-[40px] w-[240px] h-[100px] md:w-[442px] md:h-[121px] md:ml-[100px] lg:ml-[240px] lg:h-[155px] lg:w-[605px] xl:ml-[570px] bg-white flex flex-col items-start p-6 sm:p-10 gap-0 shadow-lg">
          ...
          <div className="flex items-center mt-[-20px] ml-[-10px] sm:ml-[-20px] gap-2 md:mt-[-20px] lg:mt-[-10px]">
            ...
            B700N/H7N Single Balanced Seals 
            </h4>
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="B700N/H7N Single Balanced Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`B700N/H7N Single Balanced Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
