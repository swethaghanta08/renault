...
const UG100Single = () => {
  ...
  const materialOptions = ["Seal face: Carbon graphite antimony impregnated (A), Silicon carbide (Q12)",
    ...
    "Elastomer: NBR (P), EPDM (E), FKM (V), Metal parts: CrNiMo steel (G), Hastelloy® C-4 (M).",
  ]
  const performanceCapabilities = [
    "Sizes: d1 = Up to 100 mm (Up to 4.000’’)",
    "Pressure: p1 = 16 bar (230 PSI)",
    "Vacuum: 0.5 bar (7.25 PSI), up to 1 bar (14.5 PSI) with seat locking",
