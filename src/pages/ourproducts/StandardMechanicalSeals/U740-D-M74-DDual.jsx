...
const U740 = () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/U740/image1.jpg")
  ...
  useEffect(() => {
    ...
    const productImages = [
      "/assets/Ourproducts/StandardMechanicalSeals/U740/image1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/U740/image2.png",
    ];
  ...
  const productFeatures = [
    ...
    "Pumping device available for increased efficiency in circulation (B740F-D)",
    "The B740-D Dual Balanced Seals, in particular, feature the following characteristics.",
  ]
  ...
  const technicalFeatures = [
    ...
    "Pumping device to increase efficiency in circulation for media with higher viscosity available",
    "Short installation length available on request",
    "Suitable for media with low solids content",
    "EN 12756 (For connection dimensions d1 up to 100 mm)"
  ]
  ...
  const industrialApplications = [
    ...
    "Medias with low solids content and abrasive particles",
    "Process industry",
  ...
  const performanceCapabilities = [
    "  Sizes: d1 = Upto 200 mm (Upto 7.875’’))", "(Pressure: p1 = 80 bar (1160 PSI) for d1 = 14 ... 100 mm,",
    "p1 = 25 bar (363 PSI) for d1 = 100 ... 200 mm,", "p1 = 16 bar (232 PSI) for d1 > 200 mm", "Temperature: t = -50 °C...+220 °C(- 58 °F...+428 °F)",
    "Speed = 20 m/s (66 ft /s)",
    "Permissible axial movement: d1 up to 100 mm: ± 0.5 mm d1 from 100 mm: ± 2.0 mm",
   
  ]

  const partsList = [
    { no: "1.1", description: "Seal Face" },
    { no: "1.2", description: "Seal Face" },
    ...
    { no: "1.8", description: "O-Ring" },
    { no: "2", description: "Seat (G9)" },
    { no: "3", description: "O-Ring" },
    { no: "4", description: "Seat (G9)" },
  ...
  return (
    <>
      <Helmet>
        <title>U740-D Dual Balanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="U740-D Dual Balanced Seals: dual seal configuration, balanced design, versatile torque transmission, and more. Explore technical features, applications, and material options." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/U740/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/U740/image2.png" />
      </Helmet>
      <section
          ...
          <div className="w-full lg:w-auto lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
              <img
                ...
                alt="U740-D Dual Balanced Seal main product image"
              ...
              {thumbnails.map((thumb, index) => (
                ...
                >
                  <img
                    ...
                    alt={`U740-D Dual Balanced Seal thumbnail ${index + 1}`}
                    className="w-full h-full object-contain"
                    loading="lazy"
                    width="80"
                    height="80"
