...
const BRNSingleBalanced = () => {

  const [activeTab, setActiveTab] = useState(null)
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/BRNSinglebalancedseals/image1.jpg")
  ...
  useEffect(() => {
    const imagesToPreload = [
      ...
      "/assets/Ourproducts/StandardMechanicalSeals/BRNSinglebalancedseals/image1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/BRNSinglebalancedseals/image2.jpg"
    ]
  ...
  const productFeatures = [
    ...
    "BRN Single Balanced Seals : ",
    "High-performance, reliable sealing solution for various industrial applications.",
    "These are to provide effective sealing solutions for various applications. ",
    "These seals feature a balanced design that ensures optimal performance and reliability.",
    "With their robust construction and high-quality materials, BRN Single Balanced Seals offer excellent resistance to wear and corrosion. ",
    "They are capable of handling demanding operating conditions while preventing leakage and minimizing downtime. ",
    "These seals are suitable for use in a wide range of industries, including chemical processing, oil and gas, and power generation, where dependable sealing performance is essential."
  ]
  ...
  const partsList = [
    ...
    { no: "1.3", description: "	Retainer" },
    { no: "1.4", description: "Spring" },
    { no: "1.5", description: "O-Ring" },
    { no: "2", description: "Seat" },
    { no: "3", description: "O-Ring" },
    { no: "4", description: "Drive Collar" },
    { no: "5", description: "O-Ring" },
    { no: "6", description: "Set screw" },
  ...
  return (
    <>
      <Helmet>
        <title>BRN/HRN Single Balanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="BRN/HRN Single Balanced Seals: high-performance, reliable, balanced design for industrial applications. See features, materials, and technical details." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/BRNSinglebalancedseals/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/BRNSinglebalancedseals/image2.jpg" />
      </Helmet>
      <section
        ...
        aria-label="BRN/HRN Single Balanced Seals hero section"
      >
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="BRN/HRN Single Balanced Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`BRN/HRN Single Balanced Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
...
export default BRNSingleBalanced
