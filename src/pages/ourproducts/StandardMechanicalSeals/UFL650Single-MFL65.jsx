...
const UFL650Single = () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/UFL650/image1.jpg")
  ...
  useEffect(() => {
    ...
    const productImages = [
      "/assets/Ourproducts/StandardMechanicalSeals/UFL650/image1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/UFL650/image2.jpg",
    ];
  ...
  const productFeatures = [
    ...
    "The UFL650 Single Balanced Seals are high-performance sealing devices designed for various industrial applications. With their single balanced design, they provide reliable sealing, reduced leakage, and extended service life. These seals offer exceptional performance and durability, making them an ideal choice for demanding operating conditions.",
    
  ]

  const technicalFeatures = [
    "Suitable for very high temperature application",
    "Can handle high sliding velocities",
    "No elastomer secondary seals",
    "Rugged design for long operating life",
    "Bellows design efficiently ensure self- cleaning",
  ]
  ...
  const materialOptions = ["Bellows: Inconel® 718 (M6), Hastelloy® C-276 (M5)",
  ...
  const performanceCapabilities = [
    "Sizes: d1 = Upto 100 mm (Upto 4.000’’)", "Externally pressurized: p1 = 25 bar (363 PSI), (higher pressure possible, please inquire)",
    "Internally pressurized:p1 <120 °C (248 °F) 10 bar (145 PSI)", "p1 <220 °C (428 °F) 5 bar (73 PSI)", "p1 <400 °C (752 °F) 3 bar (44 PSI)",
    "Stationary seat lock necessary",
    "Temperature: t = -20 °C ... +400 °C (-4 °F ... +752 °F) Speed = 50 m/s (165 ft/s)",
   
  ]

  const partsList = [
    { no: "1.1", description: "Seal Face and Bellow Unit" },
    { no: "1.2", description: "Flat gasket" },
  ...
  return (
    <>
      <Helmet>
        <title>UFL650/MFL65 Single Balanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="UFL650/MFL65 Single Balanced Seals: single seal configuration, balanced design, metal bellows, and more. Explore technical features, applications, and material options." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/UFL650/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/UFL650/image2.jpg" />
      </Helmet>
      <section
        ...
        <div className="relative z-10 ml-[20px] sm:ml-[40px] mt-[80px] aboutcontentbox2 aboutcontentbox md:mt-[40px] w-[240px] h-[100px] md:w-[442px] md:h-[121px] md:ml-[100px] lg:ml-[240px] lg:h-[155px] lg:w-[605px] xl:ml-[570px] bg-white flex flex-col items-start p-6 sm:p-10 gap-0 shadow-lg">
          ...
          <div className="flex items-center mt-[-20px] ml-[-10px] sm:ml-[-20px] gap-2 md:mt-[-20px] lg:mt-[-10px]">
            <h4 className="text-[#CF422A] mt-[30px] xl:mt-[30px] font-[Monda] text-[12px] md:text-[20px] lg:text-[24px] lg:mt-[10px] font-bold leading-normal capitalize">
              UFL650/MFL65 Single Balanced Seals
            </h4>
          </div>
        </div>
      </section>
          ...
          <div className="w-full lg:w-auto lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
              <img
                ...
                alt="UFL650/MFL65 Single Balanced Seal main product image"
              ...
              {thumbnails.map((thumb, index) => (
                ...
                >
                  <img
                    ...
                    alt={`UFL650/MFL65 Single Balanced Seal thumbnail ${index + 1}`}
                    className="w-full h-full object-contain"
                    loading="lazy"
                    width="80"
                    height="80"
