...
const U200NSingle= () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/U200/image1.jpg")
  ...
  useEffect(() => {
    const imagesToPreload = [
      ...
      "/assets/Ourproducts/StandardMechanicalSeals/U200/image1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/U200/image2.jpg"
    ]
  ...
  const productFeatures = [
    ...
    "The U200N Single Unbalanced Seals is a mechanical sealing device designed for use in various applications.  ",
    "It features a single seal face that is unbalanced, providing effective sealing against fluid leakage in systems with low pressure and non-hazardous conditions",
  ]
  ...
  return (
    <>
      <Helmet>
        <title>U200N/M2N Single Unbalanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="U200N/M2N Single Unbalanced Seals: single seal, unbalanced, for plain shafts and low pressure. See features, materials, and technical details." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/U200/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/U200/image2.jpg" />
      </Helmet>
      <section
        ...
        aria-label="U200N/M2N Single Unbalanced Seals hero section"
      >
        ...
        <div className="relative z-10 ml-[20px] sm:ml-[40px] mt-[80px] aboutcontentbox2 aboutcontentbox md:mt-[40px] w-[240px] h-[100px] md:w-[442px] md:h-[121px] md:ml-[100px] lg:ml-[240px] lg:h-[155px] lg:w-[605px] xl:ml-[570px] bg-white flex flex-col items-start p-6 sm:p-10 gap-0 shadow-lg">
          ...
          <div className="flex items-center mt-[-20px] ml-[-10px] sm:ml-[-20px] gap-2 md:mt-[-20px] lg:mt-[-10px]">
            ...
            U200N/M2N Single Unbalanced Seals
            </h4>
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="U200N/M2N Single Unbalanced Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`U200N/M2N Single Unbalanced Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
