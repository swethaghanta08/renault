...
const Compact = () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/B100singlebalancedseals/image1.jpg")
  ...
  useEffect(() => {
    const imagesToPreload = [
      ...
      "/assets/Ourproducts/StandardMechanicalSeals/B100singlebalancedseals/image1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/B100singlebalancedseals/image2.jpg"
    ]
  ...
  const productFeatures = [
    ...
    "The B100/B800 Single Balanced Seals are advanced sealing systems designed for industrial applications.",
    "These seals feature a single balanced design, ensuring efficient operation and reduced leakage. They are constructed with high-quality materials that provide excellent resistance to corrosion and wear. ",
    "The B100/B800 seals offer reliable performance in challenging environments, maintaining fluid containment and preventing external contaminants from entering the system. ",
    "With their robust construction and optimized design, these seals are ideal for demanding sealing applications.",
  ]
  ...
  const technicalFeatures = [
    ...
    "Spring loaded stationary design accommodates shaft misalignments",
    "Can handle media with solid content",
    "Easy to assemble due to short axial installation length",
    
  ]

  const industrialApplications = [
    "All seal chambers with a very short axial installation lengt",
    "Bearing seal",
    "Lube oils",
    "Process industry",
    "Roller seal",
  ...
  const performanceCapabilities = [
    ...
    "Temperature: t = -40 °C...+180 °C(-40 °F...+356 °F)",
    "Speed = 50 m/s (164 ft/s)",
  ]

  const partsList = [
    { no: "1.1", description: "Seal Face" },
    { no: "", description: "Seal Face Housing" },
    { no: "1.2", description: "Drive Collar" },
    { no: "1.3", description: "O-Ring" },
    { no: "1.4", description: "Spring" },
    { no: "2", description: "Rotating seat *" },
  ...
  return (
    <>
      <Helmet>
        <title>B100/B800/H10/H8 Single Balanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="B100/B800/H10/H8 Single Balanced Seals: advanced, robust, and reliable sealing for industrial applications. See features, materials, and technical details." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/B100singlebalancedseals/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/B100singlebalancedseals/image2.jpg" />
      </Helmet>
      <section
        ...
        aria-label="B100/B800/H10/H8 Single Balanced Seals hero section"
      >
        ...
        <div className="relative z-10 ml-[20px] sm:ml-[40px] mt-[80px] aboutcontentbox2 aboutcontentbox md:mt-[40px] w-[240px] h-[100px] md:w-[442px] md:h-[121px] md:ml-[100px] lg:ml-[240px] lg:h-[155px] lg:w-[605px] xl:ml-[570px] bg-white flex flex-col items-start p-6 sm:p-10 gap-0 shadow-lg">
          <h2 className="text-black mt-[-20px] ml-[-10px] md:mt-[-40px] mt-[-20px] xl:mt-[-20px] sm:ml-[-20px] font-monda text-[18px] sm:text-[20px] md:text-[28px] lg:text-[36px] font-bold leading-[24px] sm:leading-[28px] md:leading-[50px] w-[216px] md:w-[402px] lg:w-[502px]">
          ...
          <div className="flex items-center mt-[-20px] ml-[-10px] sm:ml-[-20px] gap-2 md:mt-[-20px] lg:mt-[-10px]">
            ...
            B100/B800/H10/H8 Single Balanced Seals
            </h4>
          </div>
        </div>
      </section>
          ...
          <div className="w-full lg:w-auto lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-7 mb-8">
              <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
                <img
                  ...
                  alt="B100/B800/H10/H8 Single Balanced Seal main product image"
                ...
                {thumbnails.map((thumb, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`B100/B800/H10/H8 Single Balanced Seal thumbnail ${index + 1}`}
                      className="w-full h-full object-contain"
                      loading="lazy"
                    />
                  </div>
            ...
            <div className="flex flex-col gap-3 w-full ">
              ...
              <div className="w-full">
                <div
                  className={`flex justify-between items-center p-4 px-6 w-full cursor-pointer transition-all duration-300 ${
                    activeTab === "technical" ? "bg-[#CF422A] text-white" : "bg-[#DBE6EB] text-black"
                  }`}
                ...
                <div
                  className={`overflow-hidden transition-[max-height] duration-500 ease-in-out ${
                    activeTab === "technical" ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                  }`}
                >
              ...
              <div className="w-full">
                <div
                  className={`flex justify-between items-center p-4 px-6 w-full cursor-pointer transition-all duration-300 ${
                    activeTab === "applications" ? "bg-[#CF422A] text-white" : "bg-[#DBE6EB] text-black"
                  }`}
                ...
                <div
                  className={`overflow-hidden transition-[max-height] duration-500 ease-in-out ${
                    activeTab === "applications" ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                  }`}
                >
                  <div className="p-4 px-6 bg-[#FCEDEA]">
                    <ul className="space-y-2">
              ...
              <div className="w-full">
                <div
                  className={`flex justify-between items-center p-4 px-6 w-full cursor-pointer transition-all duration-300 ${
                    activeTab === "materials" ? "bg-[#CF422A] text-white" : "bg-[#DBE6EB] text-black"
                  }`}
                ...
                <div
                  className={`overflow-hidden transition-[max-height] duration-500 ease-in-out ${
                    activeTab === "materials" ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                  }`}
                >
                  <div className="p-4 px-6 bg-[#FCEDEA]">
                    <ul className="space-y-2">
              ...
              <div className="w-full">
                <div
                  className={`flex justify-between items-center p-4 px-6 w-full cursor-pointer transition-all duration-300 ${
                    activeTab === "performance" ? "bg-[#CF422A] text-white" : "bg-[#DBE6EB] text-black"
                  }`}
                ...
                <div
                  className={`overflow-hidden transition-[max-height] duration-500 ease-in-out ${
                    activeTab === "performance" ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                  }`}
                >
                  <div className="p-4 px-6 bg-[#FCEDEA]">
                    <ul className="space-y-2">
