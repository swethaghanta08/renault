...
const UFL850NSingle = () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/UFL850/image1.jpg")
  ...
  useEffect(() => {
    ...
    const productImages = [
      "/assets/Ourproducts/StandardMechanicalSeals/UFL850/image1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/UFL850/image2.jpg",
    ];
  ...
  const productFeatures = [
    ...
    "The UFL850N Single Balanced Seal is a high-performance sealing solution designed for various industrial applications.",
    "It features a single balanced design, ensuring reliable operation and reduced leakage. With its robust construction and superior materials, the UFL850N provides optimal sealing performance in demanding environments."
  ...
  const performanceCapabilities = [
    "Sizes: d1 = Upto 100 mm (Upto 4.000’’)", "Externally pressurized: p1 = 25 bar (363 PSI)",
  ...
  return (
    <>
      <Helmet>
        <title>UFL850N Single Balanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="UFL850N Single Balanced Seals: single seal configuration, balanced design, metal bellows, and more. Explore technical features, applications, and material options." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/UFL850/image1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/UFL850/image2.jpg" />
      </Helmet>
      <section
          ...
          <div className="w-full lg:w-auto lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
              <img
                ...
                alt="UFL850N Single Balanced Seal main product image"
              ...
              {thumbnails.map((thumb, index) => (
                ...
                >
                  <img
                    ...
                    alt={`UFL850N Single Balanced Seal thumbnail ${index + 1}`}
                    className="w-full h-full object-contain"
                    loading="lazy"
                    width="80"
                    height="80"
