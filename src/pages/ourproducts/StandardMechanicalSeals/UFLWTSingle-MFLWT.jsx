...
const UFLWTSingle = () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/StandardMechanicalSeals/UFLWT/IMAGE1.jpg")
  ...
  useEffect(() => {
    ...
    const productImages = [
      "/assets/Ourproducts/StandardMechanicalSeals/UFLWT/IMAGE1.jpg",
      "/assets/Ourproducts/StandardMechanicalSeals/UFLWT/IMAGE2.jpg",
    ];
  ...
  const productFeatures = [
    ...
    "UFLWT Single Balanced Seals are mechanical seals designed for fluid containment in rotating equipment.",
    "They feature a balanced design that reduces the effects of pressure on seal faces, enhancing their performance and lifespan. These seals ensure efficient sealing while minimizing leakage and maintaining equipment integrity.",
  ]
  ...
  const materialOptions = ["Seal face: Carbon graphite antimony impregnated (A), Silicon carbide (Q12)",
    "Seat: Silicon carbide (Q1)",
    "Bellows: Inconel® 718 hardened (M6)",
    "Hastelloy® C-276 (M5)",
    "Metal parts: CrNiMo steel (G), Duplex (G1) * Cannot be combined with seal face made of S"]

  const performanceCapabilities = [
    "Sizes: d1 = Upto 150 mm (Upto 6.000’’)", "Externally pressurized: p1 = … 25 bar (363 PSI)",
    ...
    "Temperature: t = -40 °C .. +400 °C (-148 °F .. +752 °F) Speed = 20 m/s (66 ft/s)",
  ...
  return (
    <>
      <Helmet>
        <title>UFLWT/MFLWT Single Balanced Seals | Standard Mechanical Seals | Renault</title>
        <meta name="description" content="UFLWT/MFLWT Single Balanced Seals: single seal configuration, balanced design, metal bellows, and more. Explore technical features, applications, and material options." />
        ...
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/UFLWT/IMAGE1.jpg" />
        <link rel="preload" as="image" href="/assets/Ourproducts/StandardMechanicalSeals/UFLWT/IMAGE2.jpg" />
      </Helmet>
      <section
        ...
        <div className="relative z-10 ml-[20px] sm:ml-[40px] mt-[80px] aboutcontentbox2 aboutcontentbox md:mt-[40px] w-[240px] h-[100px] md:w-[442px] md:h-[121px] md:ml-[100px] lg:ml-[240px] lg:h-[155px] lg:w-[605px] xl:ml-[570px] bg-white flex flex-col items-start p-6 sm:p-10 gap-0 shadow-lg">
          ...
          <div className="flex items-center mt-[-20px] ml-[-10px] sm:ml-[-20px] gap-2 md:mt-[-20px] lg:mt-[-10px]">
            <h4 className="text-[#CF422A] mt-[30px] xl:mt-[30px] font-[Monda] text-[12px] md:text-[20px] lg:text-[24px] lg:mt-[10px] font-bold leading-normal capitalize">
              UFLWT/MFLWT Single Balanced Seals
            </h4>
          </div>
        </div>
      </section>
          ...
          <div className="w-full lg:w-auto lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px]">
              <img
                ...
                alt="UFLWT/MFLWT Single Balanced Seal main product image"
              ...
              {thumbnails.map((thumb, index) => (
                ...
                >
                  <img
                    ...
                    alt={`UFLWT/MFLWT Single Balanced Seal thumbnail ${index + 1}`}
                    className="w-full h-full object-contain"
                    loading="lazy"
                    width="80"
                    height="80"
