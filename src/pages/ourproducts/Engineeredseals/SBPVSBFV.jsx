...
const SBPVSBFV = () => {
  ...
  const partsList = [
    { no: "1.1.1", description: "Seal face pressure-stabilized" },
    { no: "1.1.3", description: "	Spring" },
    { no: "1.1.4", description: "		Back-up ring" },
    { no: "1.2", description: "Seat" },
    { no: "2", description: "Seat housing with pumping screw (F) or pumping ring (P)" },
    { no: "6", description: "Cover" },
    { no: "9", description: "Assembly fixture" },
  ...
  const thumbnails = [
    "/assets/Ourproducts/Engineeredseals/Sbpvspfv/image1.jpg",
    "/assets/Ourproducts/Engineeredseals/Sbpvspfv/image2.jpg",
  ]
