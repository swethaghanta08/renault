...
const SBFVDSBPVD = () => {
  ...
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/Engineeredseals/Sbfvsbpv/image1.jpg")
  ...
  const partsList = [
    ...
    { no: "4", description: "	Clamping sleeve" },
    { no: "6", description: "Housing" },
    { no: "8", description: "Cover" },
    { no: "10", description: "Pumping sleeve" },
  ...
  const thumbnails = [
    "/assets/Ourproducts/Engineeredseals/Sbfvsbpv/image1.jpg",
    "/assets/Ourproducts/Engineeredseals/Sbfvsbpv/image2.jpg",
  ]
