...
const PPSSingleSealsPulpPaper = () => {
  const [activeTab, setActiveTab] = useState(null)
  const [mainImage, setMainImage] = useState("/assets/Ourproducts/Engineeredseals/PPSSingleseals/image1.jpg")
  ...
  const productFeatures = [
    ...
    "The Renault engineers have developed the PP-S Single Seals specifically for the pulp and paper industry. ",
    "These seals are designed to provide efficient and reliable sealing performance in demanding conditions. With their advanced technology and robust construction, the PP-S Single Seals offer excellent resistance to high temperatures, corrosive chemicals, and abrasive media commonly found in pulp and paper processing.",
    "Their innovative design ensures minimal leakage and extended operational lifespan, contributing to improved productivity and reduced maintenance costs."
]
  ...
  const partsList = [
    { no: "1.5", description: "Seal face" },
    { no: "2, 12, 22, 23, 24", description: "O-Ring" },
  ...
  const thumbnails = [
    "/assets/Ourproducts/Engineeredseals/PPSSingleseals/image1.jpg",
    "/assets/Ourproducts/Engineeredseals/PPSSingleseals/image2.jpg",
  ]
...
export default PPSSingleSealsPulpPaper
