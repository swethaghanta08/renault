...
const menuItems = [
  ...
  {
    name: "BSH-D Dual Seals (Top Entry) – 250 bars",
    path: "/ourproducts/Mechanicalseals/BSH",
  },
  {
    name: "U184 Single & Dual Seals (Top Entry)",
    path: "/ourproducts/Mechanicalseals/U184",
  },
  {
    name: "U164 Single & Dual Seals (Top-side Entry)",
    path: "/ourproducts/Mechanicalseals/U164",
  },
  { name: "UR-D Dual Seals", path: "/ourproducts/Mechanicalseals/UR" },
  {
    name: "MXS Single & Dual Seals (Top-side Entry)",
    path: "/ourproducts/Mechanicalseals/MXS",
  },
]
...
export default Mechanicalsealsnavbar