...
const EngineeredSeals = () => {
  return (
    <div>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>Engineered Mechanical Seals | Custom Sealing Solutions | Renault Engineers</title>
        <meta
          name="description"
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-16 py-12">
        ...
        <div className="max-w-[1000px] mx-auto">
          <p className="text-[#827E7D] font-['Manrope'] text-[16px] md:text-[20px] font-normal leading-[22px] md:leading-[28px] tracking-[0.4px] mb-6">
            ...
            4. Applications of Engineered Seals: Examples of the types of applications where engineered seals are commonly used, such as in aerospace, oil and gas, automotive, and medical industries.
          </p>
          ...
          <p className="text-[#827E7D] font-['Manrope'] text-[16px] md:text-[20px] font-normal leading-[22px] md:leading-[28px] tracking-[0.4px] mb-10">
            ...
            these sections. You could also include images or videos to illustrate the information
            and make the content more engaging. Renault Engineers
          </p>
        </div>
