...
const BSHLU = () => {
  ...
  "Pressure: p1 = vacuum ... 60 bar (870 PSI)",
  "Temperature: t = -40 °C ... +200 °C (-40 °F ... +392 °F)",
  "Sliding velocity: vg = 0 ... 5 m/s (0 ... 16 ft/s) For applications beyond this range, please enquire."
  ]
  ...
  const partsList = [
    ...
    { no: "30", description: "Throttle ring" },
