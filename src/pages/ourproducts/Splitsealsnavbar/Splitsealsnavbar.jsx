...
const menuItems = [
  { name: "SPX Single Semi Catridge Seals", path: "/ourproducts/Splitseals/SPXSingleSemiCatridgeSeals" },
  {
    name: "BGH201 Single Semi Split Seals",
    path: "/ourproducts/Splitseals/BGH201SingleSemiSplitSeals",
  },
  {
...
export default Splitsealsnavbar