...
const menuItems = [
  ...
  {
    name: "SBF(V)-D / SBP(V)-D",
    path: "/ourproducts/Engineeredseals/SBFVDSBPVD",
  },
  {
    name: "SBPV/SBFV",
    path: "/ourproducts/Engineeredseals/SBPVSBFV",
  },
  {
    name: "BR Single & Dual Seals (Slurry)",
    path: "/ourproducts/Engineeredseals/BRSingleDualSealsSlurry",
  },
  { name: "PP – D Dual Seals (Pulp & Paper)", path: "/ourproducts/Engineeredseals/PPDDualSealsPulpPaper" },
  {
    name: "PP-S Single Seals (Pulp & Paper)",
    path: "/ourproducts/Engineeredseals/PPSSingleSealsPulpPaper",
  },
]
