...
const AboutHeroSection = () => {
  ...
  return (
    <section
      className="relative h-[320px] md:h-[460px] lg:h-[600px] mt-[20px] mx-auto w-full flex items-center justify-center"
    >
      ...
      {/* Content Box */}
      <div className="relative z-10 ml-[40px] mt-[80px] md:mt-[40px] md:ml-[200px] lg:ml-[240px] xl:ml-[570px] w-[240px] h-[100px] md:w-[442px] md:h-[150px] lg:w-[605px] lg:h-[235px] bg-white flex flex-col items-start p-10 md:gap-0 gap-0 lg:gap-4 shadow-lg">
        ...
        <h2 className="text-black ml-[-20px] font-[Monda] text-[20px] md:text-[28px] lg:text-[36px] sm:text-[24px] font-bold leading-[28px] md:leading-[50px] w-[216px] md:w-[402px]">
          Driven by Innovation, Committed to Quality
        </h2>
      </div>
    </section>
  );
