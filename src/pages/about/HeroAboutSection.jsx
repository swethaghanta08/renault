...
const AboutHeroSection = () => {
  ...
  useEffect(() => {
    setTimeout(() => setLoading(false), 20); // Simulating API delay
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 hidden lg:block">
        {loading ? (
          <Skeleton variant="rectangular" width={870} height={600} />
        ) : (
          <svg
      ...
      <div className="absolute top-0 right-0 hidden md:block lg:hidden">
        {loading ? (
          <Skeleton variant="rectangular" width={461} height={460} />
        ) : (
          <svg
      ...
      <div className="absolute top-0 right-0 block md:hidden">
        {loading ? (
          <Skeleton variant="rectangular" width={251} height={320} />
        ) : (
          <svg
