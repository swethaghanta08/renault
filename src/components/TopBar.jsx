...
const TopBar = () => {
  return (
    <div className="w-full mx-auto border-b-[1px] border-[#827E7D]">
      {/* Desktop & Tablet View */}
      <div className="hidden md:flex mx-auto items-center justify-between md:px-8 md:py-2 lg:px-12 lg:py-2 xl:px-16 xl:py-2">
        {/* Left - Social Connect */}
        <div className="flex items-center text-[#827E7D] font-[Monda] md:text-[14px] lg:text-[16px] xl:text-[20px]">
          <span>Social Connect</span>
          <div className="flex items-center ml-4 space-x-2">
      ...
      {/* Mobile View */}
      <div className="flex md:hidden items-center justify-between px-4 py-1 max-w-[425px] mx-auto">
        {/* Left - ISM Certification */}
        <div className="flex-1 text-left text-[#827E7D] font-[Monda] text-[12px] capitalize whitespace-nowrap">
          Welcome to Renault Engineers
        </div>
